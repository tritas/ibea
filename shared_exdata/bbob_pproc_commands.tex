\providecommand{\algname}{ibea pop100 offs20 mut0.01 recomb1.0 var5.0 on bbob-biobj budget0500xD-001{}}
\providecommand{\algfolder}{ibea_pop100_offs20_mut0.01_recomb1.0_var5.0_on_bbob-biobj_budget0500xD-001/}
...
\providecommand{\algname}{ibea pop100 offs20 mut0.8 recomb0.5 var5.0 on bbob-biobj budget0500xD-003{}}
\providecommand{\algfolder}{ibea_pop100_offs20_mut0.8_recomb0.5_var5.0_on_bbob-biobj_budget0500xD-003/}
\providecommand{\bbobecdfcaptionallgroups}{
Empirical cumulative distribution of simulated (bootstrapped) runtimes, measured in number
         of objective function evaluations, divided by dimension (FEvals/DIM) for the $58$ targets $\{-10^{-4}, -10^{-4.2}, $ $-10^{-4.4}, -10^{-4.6}, -10^{-4.8}, -10^{-5}, 0, 10^{-5}, 10^{-4.9}, 10^{-4.8}, \dots, 10^{-0.1}, 10^0\}$ for all function groups and all dimensions. The aggregation over all 55 functions is shown in the last plot.
}
...
\providecommand{\algname}{ibea pop100 offs20 mut0.8 recomb0.8 var5.0 on bbob-biobj budget0500xD-001{}}
\providecommand{\algfolder}{ibea_pop100_offs20_mut0.8_recomb0.8_var5.0_on_bbob-biobj_budget0500xD-001/}
\providecommand{\bbobecdfcaptionallgroups}{
Empirical cumulative distribution of simulated (bootstrapped) runtimes, measured in number
         of objective function evaluations, divided by dimension (FEvals/DIM) for the $58$ targets $\{-10^{-4}, -10^{-4.2}, $ $-10^{-4.4}, -10^{-4.6}, -10^{-4.8}, -10^{-5}, 0, 10^{-5}, 10^{-4.9}, 10^{-4.8}, \dots, 10^{-0.1}, 10^0\}$ for all function groups and all dimensions. The aggregation over all 55 functions is shown in the last plot.
}
...
\providecommand{\algname}{ibea pop100 offs20 mut1.0 recomb0.8 var5.0 on bbob-biobj budget0500xD-001{}}
\providecommand{\algfolder}{ibea_pop100_offs20_mut1.0_recomb0.8_var5.0_on_bbob-biobj_budget0500xD-001/}
\providecommand{\bbobecdfcaptionallgroups}{
Empirical cumulative distribution of simulated (bootstrapped) runtimes, measured in number
         of objective function evaluations, divided by dimension (FEvals/DIM) for the $58$ targets $\{-10^{-4}, -10^{-4.2}, $ $-10^{-4.4}, -10^{-4.6}, -10^{-4.8}, -10^{-5}, 0, 10^{-5}, 10^{-4.9}, 10^{-4.8}, \dots, 10^{-0.1}, 10^0\}$ for all function groups and all dimensions. The aggregation over all 55 functions is shown in the last plot.
}
